...
# Add the Genie class and its dependencies here
...
class Genie:
    ...
    @staticmethod
    def text_split(documents: PyPDFLoader):
...
genie = Genie("Siri Guru Granth.pdf")
...
def ask_question(query: Query):
    response = genie.ask(query.query)
    return {"answer": response}

@app.get("/")
def read_root():
    return {"message": "Welcome to the Genie API!"}
